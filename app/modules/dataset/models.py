...
class DataSet(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            "community_url": (
                url_for("community.view_community", community_id=self.community_id, _external=True)
                if self.community
                else None
            ),
        }
...
class Community(db.Model):
    ...
    owners = db.relationship(
        "User", secondary=community_owners, backref=db.backref("owned_communities", lazy="dynamic"), lazy="dynamic"
    )

    members = db.relationship(
        "User", secondary=community_members, backref=db.backref("joined_communities", lazy="dynamic"), lazy="dynamic"
    )

    requests = db.relationship(
        "User", secondary=community_request, backref=db.backref("requested_communities", lazy="dynamic"), lazy="dynamic"
    )
