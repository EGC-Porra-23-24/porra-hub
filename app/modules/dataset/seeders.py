...
from app.modules.dataset.models import DataSet, DSMetaData, PublicationType, DSMetrics, Author, Community
...
class DataSetSeeder(BaseSeeder):
    ...
    def run(self):
        ...
        ds_metrics_list = [
            base_ds_metrics,
            little_models_ds_metrics,
            many_models_ds_metrics,
            little_features_ds_metrics,
            many_features_ds_metrics,
        ]
        ...
        datasets = [
            DataSet(
                ...
                created_at=datetime.strptime(
                    "2024-12-9" if i == 1 else "2024-12-11" if i == 2 else "2024-12-10", "%Y-%m-%d"
                ),
            )
            for i in range(7)
        ]
